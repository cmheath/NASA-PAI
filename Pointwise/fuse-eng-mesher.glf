...
set fileName                 "fuse-eng.pw";  # Aircraft geometry filename
...
set wingTailConsCollection [pw::Collection create]
    $wingTailConsCollection set [lsort -unique [join [list $upperNoseCons      \
                                                           $lowerNoseCons      \
                                                           $fuselageCons       \
                                                           $fuseUpperTECons    \
                                                           $fuseLowerTECons]]]
...
set surfDoms [list $modelDoms(nose-upper)                \
                   $modelDoms(nose-lower)                \
                   $modelDoms(fuselage)                  \
