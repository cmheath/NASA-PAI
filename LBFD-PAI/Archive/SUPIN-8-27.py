...
class Throat(VariableTree):
    ...
    stclth = Float(12.0, desc = 'Angle of incidence of the subsonic cowl lip at the symmetry plane', units = 'deg')
...
class EngineFace(VariableTree):
    ...
    FyEF = Float(0.75, desc = 'Input for the vertical position of the center of the engine face', units = 'ft')
