...
class Throat(VariableTree):
    ...
    stclphi = Float(180.0, desc = 'Circumferential extent of subsonic cowl lip (<=0 for no subsonic cowl lip)', units = 'deg')
    Fstcldx = Float(0.17, desc = 'Axial displacement of the subsonic cowl lip at the symmetry plane', units = 'ft')
